...
def generate_gromet() -> Gromet:
    ...
    chime_model_description = \
        ModelDescription(uid=UidMetadatum('chime_model_description'),
                         ...
                         name='CHIME v02 [SIR dynamics and enclosing inner loop of sim_sir()]',
    ...
    chime_model_interface = \
        ModelInterface(uid=UidMetadatum("chime_model_interface"),
                       provenance=Provenance(method=MetadatumMethod('Manual_claytonm@az'),
                                             timestamp=get_current_datetime()),
                       variables=[UidVariable("V:simsir.in.s"),
                                  UidVariable("V:simsir.out.s")
                                  # UidVariable("V:sir.s_in"),
                                  # UidVariable("V:sir.s_out"),
                                  # UidVariable("V:sir.i_in"),
                                  # UidVariable("V:sir.i_out"),
                                  # UidVariable("V:sir.r_in"),
                                  # UidVariable("V:sir.r_out")
                                  ],  # todo update
                       parameters=[UidVariable("V:simsir.in.s"),
                                   # UidVariable("V:sir.n"),
                                   # UidVariable("V:sir.beta"),
                                   # UidVariable("V:sir.gamma")
                                   ],  # todo update
                       initial_conditions=[UidVariable("V:simsir.in.s"),
                                           # UidVariable("V:sir.s_in"),
                                           # UidVariable("V:sir.i_in"),
                                           # UidVariable("V:sir.r_in")
                                           ]  # todo update
    ...
    variables = [
        ...
        # todo: variables for temporarily wiring outer simsir stub -- rewire when updated
        Variable(uid=UidVariable("V:simsir.in.s"),
                 name="s", type=UidType("Integer"),
                 proxy_state=UidPort("P:simsir.in.s"),
                 states=[UidPort("P:simsir.in.s"),
                         UidWire("W:simsir.in.s>simsir_loop_1_1.in.s"),
                         UidPort("P:simsir_loop_1_1.in.s")],
                 metadata=None),
        Variable(uid=UidVariable("V:simsir.out.s"),
                 name="s", type=UidType("Integer"),
                 proxy_state=UidPort("P:simsir.out.s"),
                 states=[UidPort("PC:simsir_loop_1_1.out.s"),
                         UidWire("W:simsir_loop_1_1.out.s>simsir.out.s"),
        ...
        # UidPort("P:simsir_loop_1_1_cond.in.d_idx")
        ...
        # d_idx "updated"
        # UidWire("W:simsir_loop_1_1_get_d_idx_exp.out.d_idx>"),
        ...
        # UidPort("PC:simsir_loop_1_1_call_sir_exp.in.s")
    ...
    simsir_loop_1_1 = \
        Loop(uid=UidBox("B:simsir_loop_1_1"),
             type=None,
             name=None,
             ports=[UidPort("P:simsir_loop_1_1.in.d_idx"),
                    UidPort("P:simsir_loop_1_1.in.loop_1_1_seq"),
                    UidPort("P:simsir_loop_1_1.in.loop_1_1_i"),
                    UidPort("PC:simsir_loop_1_1.out.d_idx"),
             ...
             # contents
             wires=[UidWire("W:simsir_loop_1_1.in.d_idx>simsir_loop_1_1_cond.in.d_idx"),
                    UidWire("W:simsir_loop_1_1.in.loop_1_1_seq>simsir_loop_1_1_cond.in.loop_1_1_seq"),
                    UidWire("W:simsir_loop_1_1.in.loop_1_1_i>simsir_loop_1_1_i_exp.in.loop_1_1_i"),
                    UidWire("W:simsir_loop_1_1.in.loop_1_1_seq>simsir_loop_1_1_get_d_idx_exp.in.loop_1_1_seq"),
                    UidWire("W:simsir_loop_1_1_i_exp.out.loop_1_1_i>simsir_loop_1_1_get_d_idx_exp.in.loop_1_1_i"),
                    ...
                    UidWire("W:simsir_loop_1_1_call_sir_exp.out.r>simsir_loop_1_1.out.r")],
             junctions=None,
             boxes=[UidBox("B:simsir_loop_1_1_i_exp"),
                    UidBox("B:simsir_loop_1_1_get_d_idx_exp"),
                    UidBox("Bcall:simsir_loop_1_1_call_sir_exp")],
    ...
    simsir = Function(uid=UidBox("B:simsir"),
                      ...
                      # contents
                      wires=[UidWire("W:simsir.in.s>simsir_loop_1_1.in.s"),   # todo update when updating simsir
                             UidWire("W:simsir_loop_1_1.out.s>simsir.out.s")  # todo update when updating simsir
                             ],

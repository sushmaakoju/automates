...
def generate_gromet() -> Gromet:
    ...
    chime_model_description = \
        ModelDescription(uid=UidMetadatum('chime_model_description'),
                         ...
                         description='The CHIME model including the core SIR dynamics and '
                                     ...
                                     'rate and its impact on beta (infection rate).')
    ...
    variables_sir = [
        # Variables will be automatically generated in post-processing
    ]
    ...
    ports_main_loop_1 = [
        ...
        Port(uid=UidPort("P:main_loop_1.in.relative_contact_rate"),
             ...
             type=UidType("PortInput"),
             value_type=UidType("Float"),
             name="<p>.relative_contact_rate",  # TODO debug
             value=None, metadata=None),
        ...
        PortCall(uid=UidPort("PC:main_loop_1.out.relative_contact_rate"),
                 ...
                 type=UidType("PortOutput"),
                 value_type=UidType("Float"),
                 name="<PC>.relative_contact_rate",  # TODO debug
                 value=None,
                 metadata=None),
    ...
    junctions_main = [
        ...
        Junction(uid=UidJunction("J:main.relative_contact_rate"),
                 name='<J>.relative_contact_rate', # TODO debug
                 type=None,
                 value=Literal(uid=None,
                               type=UidType('Float'),
                               value=Val('0.05'),

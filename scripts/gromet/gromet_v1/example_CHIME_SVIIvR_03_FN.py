...
def generate_gromet() -> Gromet:
    ...
    chime_model_interface = \
        ModelInterface(
            ...
            variables=[
                ...
                # # infectious_days       : UidJunction("J:main.infectious_days")
                # UidVariable("V:infectious_days"),

                # CHIME_SVIIvR
                # infectious_days_unvaccinated  : UidJunction("J:main.infectious_days_unvaccinated")
                UidVariable("V:infectious_days_unvaccinated"),

                # CHIME_SVIIvR
                # infectious_days_vaccinated    : UidJunction("J:main.infectious_days_vaccinated")
                UidVariable("V:infectious_days_vaccinated"),
    ...
    wires_main = [
        ...
        Wire(uid=UidWire("W:main.infectious_days_unvaccinated>main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated"),
             type=None,
             value_type=UidType("Float"),
             name=None, value=None, metadata=None,
             src=UidJunction("J:main.infectious_days_unvaccinated"),
             tgt=UidPort("P:main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated")),
        ...
        Wire(uid=UidWire("W:main.infectious_days_vaccinated>main_gamma_vaccinated_exp.in.infectious_days_vaccinated"),
             type=None,
             value_type=UidType("Float"),
             name=None, value=None, metadata=None,
             src=UidJunction("J:main.infectious_days_vaccinated"),
             tgt=UidPort("P:main_gamma_vaccinated_exp.in.infectious_days_vaccinated")),
        ...
        # REMOVE_CHIME_SIR_Base
        # Wire(uid=UidWire("W:main.infectious_days>main_gamma_exp.in.infectious_days"),
        #      type=None,
        #      value_type=UidType("Integer"),
        #      name=None, value=None, metadata=None,
        #      src=UidJunction("J:main.infectious_days"),
        #      tgt=UidPort("P:main_gamma_exp.in.infectious_days")),
    ...
    ports_main = [
        ...
        Port(uid=UidPort("P:main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated"),
             box=UidBox("B:main_gamma_unvaccinated_exp"),
             type=UidType("PortInput"),
             value_type=UidType("Float"),
             name="infectious_days_unvaccinated",
             value=None, metadata=None),
        ...
        Port(uid=UidPort("P:main_gamma_vaccinated_exp.in.infectious_days_vaccinated"),
             box=UidBox("B:main_gamma_vaccinated_exp"),
             type=UidType("PortInput"),
             value_type=UidType("Float"),
             name="infectious_days_vaccinated",
             value=None, metadata=None),
        ...
        # main_gamma_exp in
        # REMOVE_CHIME_SIR_Base
        # Port(uid=UidPort("P:main_gamma_exp.in.infectious_days"),
    ...
    junctions_main = [
        ...
        # REMOVE_CHIME_SIR_Base
        # Junction(uid=UidJunction("J:main.infectious_days"),
        #          name='infectious_days',
        #          type=None,
        #          value=Literal(uid=None,
        #                        type=UidType('Float'),
        ...
        Junction(uid=UidJunction("J:main.infectious_days_unvaccinated"),
                 name='infectious_days_unvaccinated',
                 type=None,
                 value=Literal(uid=None,
                               type=UidType('Integer'),
                 ...
                 value_type=UidType('Integer'),
                 metadata=None),
        Junction(uid=UidJunction("J:main.infectious_days_vaccinated"),
                 name='infectious_days_vaccinated',
                 type=None,
                 value=Literal(uid=None,
                               type=UidType('Integer'),
    ...
    #                        value=Val('1.0'),
    #                        name=None, metadata=None),
    #                UidPort("P:main_gamma_exp.in.infectious_days")])
    # main_gamma_exp = \
    #     Expression(uid=UidBox("B:main_gamma_exp"),
    #                type=None,
    #                name=None,
    #                ports=[UidPort("P:main_gamma_exp.in.infectious_days"),
    ...
    main_gamma_unvaccinated_exp_e0 = \
        Expr(call=RefOp(UidOp('/')),
             args=[Literal(uid=None,
                           ...
                           value=Val('1.0'),
                           name=None, metadata=None),
                   UidPort("P:main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated")])
    main_gamma_unvaccinated_exp = \
        Expression(uid=UidBox("B:main_gamma_unvaccinated_exp"),
                   type=None,
                   name=None,
                   ports=[UidPort("P:main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated"),
    ...
    main_gamma_vaccinated_exp_0 = \
        Expr(call=RefOp(UidOp('/')),
             args=[Literal(uid=None,
                           ...
                           value=Val('1.0'),
                           name=None, metadata=None),
                   UidPort("P:main_gamma_vaccinated_exp.in.infectious_days_vaccinated")])
    main_gamma_vaccinated_exp = \
        Expression(uid=UidBox("B:main_gamma_vaccinated_exp"),
                   type=None,
                   name=None,
                   ports=[UidPort("P:main_gamma_vaccinated_exp.in.infectious_days_vaccinated"),
    ...
    main = \
        Function(uid=UidBox("B:main"),
                 ...
                 junctions=[
                     ...
                     # REMOVE_CHIME_SIR_Base
                     # UidJunction("J:main.infectious_days"),

                     ### -- CHIME_SVIIvR -- START
                     UidJunction("J:main.infectious_days_unvaccinated"),
                     UidJunction("J:main.infectious_days_vaccinated"),
                 ...
                 wires=[
                     ...
                     # REMOVE_CHIME_SIR_Base
                     # UidWire("W:main.infectious_days>main_gamma_exp.in.infectious_days"),
                     ...
                     UidWire("W:main.infectious_days_unvaccinated>main_gamma_unvaccinated_exp.in.infectious_days_unvaccinated"),
                     UidWire("W:main_gamma_unvaccinated_exp.out.gamma_unvaccinated>main_loop_1.in.gamma_unvaccinated"),
                     UidWire("W:main.infectious_days_vaccinated>main_gamma_vaccinated_exp.in.infectious_days_vaccinated"),

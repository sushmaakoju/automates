...
def generate_gig() -> ig.GrometIntersectionGraph:
    ...
    common_nodes = [
        ig.CommonNode(
            ...
            g2_variable=[ig.UidVariable("V:sviivr.s_in")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("I_in"),
            # type='input',
            g1_variable=[ig.UidVariable("V:sir.i_in")],
            g2_variable=[ig.UidVariable("V:sviivr.i_in")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("R_in"),
            # type='input',
            g1_variable=[ig.UidVariable("V:sir.r_in")],
            g2_variable=[ig.UidVariable("V:sviivr.r_in")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("beta"),
            # type='input',
            g1_variable=[ig.UidVariable("V:simsir_loop_1.beta")],
            g2_variable=[ig.UidVariable("V:simsviivr_loop_1.beta")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("gamma"),
            # type='input',
            g1_variable=[ig.UidVariable("V:main.gamma")],
            g2_variable=[ig.UidVariable("V:main.gamma")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("n"),
            # type='input',
            g1_variable=[ig.UidVariable("V:simsir_loop_1.n")],
            g2_variable=[ig.UidVariable("V:simsviivr_loop_1.n")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("scale"),
            # type='internal',
            g1_variable=[ig.UidVariable("V:sir.scale")],
            g2_variable=[ig.UidVariable("V:sviivr.scale")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("S_n"),
            # type='internal',
            g1_variable=[ig.UidVariable("V:sir.s_n")],
            g2_variable=[ig.UidVariable("V:sviivr.s_n")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("I_n"),
            # type='internal',
            g1_variable=[ig.UidVariable("V:sir.i_n")],
            g2_variable=[ig.UidVariable("V:sviivr.i_n")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("R_n"),
            # type='internal',
            g1_variable=[ig.UidVariable("V:sir.r_n")],
            g2_variable=[ig.UidVariable("V:sviivr.r_n")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("S_out"),
            # type='output',
            g1_variable=[ig.UidVariable("V:sir.s_out")],
            g2_variable=[ig.UidVariable("V:sviivr.s_out")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("I_out"),
            # type='output',
            g1_variable=[ig.UidVariable("V:sir.i_out")],
            g2_variable=[ig.UidVariable("V:sviivr.i_out")],
        ),
        ig.CommonNode(
            uid=ig.UidCommonNode("R_out"),
            # type='output',
            g1_variable=[ig.UidVariable("V:sir.r_out")],
            g2_variable=[ig.UidVariable("V:sviivr.r_out")],
        ),
    ]
    ...
    noap_nodes = [
        ig.NOAPNode(
            ...
            variables=[
                ig.UidVariable("V:main.v_r"),
                ig.UidVariable("V:main.v_s"),
                ig.UidVariable("V:simsviivr_loop_1.v"),
                ig.UidVariable("V:simsviivr_loop_1.i_v"),
            ],
        ),
        ig.NOAPNode(
            ...
            gromet_name=ver_chime_sviivr_name,
            variables=[
                ig.UidVariable("V:sviivr.v_n"),
                ig.UidVariable("V:sviivr.i_v_n"),
            ],
        ),
        ig.NOAPNode(
            ...
            gromet_name=ver_chime_sviivr_name,
            variables=[
                ig.UidVariable("V:sviivr.v"),
                ig.UidVariable("V:sviivr.i_v"),
            ],
        ),
    ]
